...
<body id="home">
    ...
    <form method="post" action="home.php">
        ...
        <input type="text" name="admission" placeholder="Enter Admission number" id="admission"><br><br>
    ...
    if (isset($_POST['admission']) and isset($_POST['roll']) && strlen($_POST['admission']) && strlen($_POST['roll'])) {
        ...
        echo "<a href='../index.php'> <input type='submit' name=`home` id=`home_btn` value='Home'> </a>";
